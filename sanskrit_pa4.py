...
prompt = """Act as a Sanskrit professor.
            ...
            list all nouns in the text in a valid JSON array with the following fields:
            ...
            Respond with valid JSON array only. Do not include any extra text or commentary.
...
st.markdown('Input a Sanskrit sentence and the AI will provide you \n\
